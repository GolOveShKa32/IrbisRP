...
function aPlayerInterior ( player )
	if ( aInteriorForm == nil ) then
		...
		aInteriorForm		= guiCreateWindow ( x / 2 - 110, y / 2 - 150, 220, 300, "Управление локациями", false )
		...
		aInteriorSelect		= guiCreateButton ( 0.03, 0.82, 0.94, 0.075, "Выбрать", true, aInteriorForm )
		aInteriorCancel		= guiCreateButton ( 0.03, 0.90, 0.94, 0.075, "Отмена", true, aInteriorForm )

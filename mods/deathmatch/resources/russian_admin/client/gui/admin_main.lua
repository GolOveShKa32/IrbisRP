...
function aAdminMenu ()
	if ( aAdminForm == nil ) then
		...
		aAdminForm			= guiCreateWindow ( x / 2 - 310, y / 2 - 260, 620, 520, "", false )
						  ...
						  guiSetText ( aAdminForm, "Админ панель  -   v".._version )
						  guiCreateLabel ( 0.75, 0.05, 0.45, 0.04, "Админ панель", true, aAdminForm )
		...
		aTab1.HideColorCodes= guiCreateCheckBox ( 0.037, 0.94, 0.20, 0.04, "Не показывать код цвета", true, true, aTab1.Tab )
		aTab1.PlayerList		= guiCreateGridList ( 0.03, 0.10, 0.20, 0.83, true, aTab1.Tab )
						  guiGridListAddColumn( aTab1.PlayerList, "Имя игрока", 0.85 )
		...
		aTab1.Mute			= guiCreateButton ( 0.71, 0.110, 0.13, 0.04, "Приглушение", true, aTab1.Tab, "mute" )
		aTab1.Freeze		= guiCreateButton ( 0.85, 0.110, 0.13, 0.04, "Заморозить", true, aTab1.Tab, "freeze" )
		aTab1.Spectate		= guiCreateButton ( 0.71, 0.155, 0.13, 0.04, "Следить", true, aTab1.Tab, "spectate" )
		aTab1.Slap			= guiCreateButton ( 0.85, 0.155, 0.13, 0.04, "Ударить "..aCurrentSlap.." _", true, aTab1.Tab, "slap" )
		...
		aTab1.Nick			= guiCreateButton ( 0.71, 0.2, 0.13, 0.07, "Задать имя", true, aTab1.Tab )
		aTab1.Shout			= guiCreateButton ( 0.85, 0.2, 0.13, 0.07, "Сообщение", true, aTab1.Tab, "shout" )
		aTab1.Admin			= guiCreateButton ( 0.71, 0.275, 0.27, 0.04, "Дать права админа", true, aTab1.Tab, "setgroup" )
	
						  guiCreateHeader ( 0.25, 0.08, 0.20, 0.04, "Игрок:", true, aTab1.Tab )
		aTab1.Name			= guiCreateLabel ( 0.26, 0.125, 0.30, 0.035, "Имя: N/A", true, aTab1.Tab )
		...
		aTab1.Area			= guiCreateLabel ( 0.26, 0.575, 0.44, 0.04, "Локация: Неизвестно", true, aTab1.Tab )
		...
		aTab1.Interior		= guiCreateLabel ( 0.45, 0.755, 0.20, 0.04, "Здание: 0", true, aTab1.Tab )
		...
		aTab1.SetSkin		= guiCreateButton ( 0.71, 0.395, 0.13, 0.07, "Задать скин", true, aTab1.Tab, "setskin" )
		aTab1.SetTeam		= guiCreateButton ( 0.85, 0.395, 0.13, 0.07, "Задать команду", true, aTab1.Tab, "setteam" )
		aTab1.SetDimension	= guiCreateButton ( 0.71, 0.77, 0.13, 0.07, "Задать измерение", true, aTab1.Tab, "setdimension" )
		aTab1.SetInterior		= guiCreateButton ( 0.85, 0.77, 0.13, 0.07, "Задать здание", true, aTab1.Tab, "setinterior" )
		...
		aTab1.SetMoney		= guiCreateButton ( 0.71, 0.515, 0.13, 0.07, "Дать деньги", true, aTab1.Tab, "setmoney" )
		aTab1.SetStats		= guiCreateButton ( 0.85, 0.515, 0.13, 0.07, "Изменить статистику", true, aTab1.Tab, "setstat" )
		...
		aTab1.WarpTo		= guiCreateButton ( 0.71, 0.68, 0.27, 0.04, "Телепорт игрока в..", true, aTab1.Tab, "warp" )
						  guiCreateHeader ( 0.25, 0.805, 0.20, 0.04, "Транспорт:", true, aTab1.Tab )
		aTab1.Vehicle		= guiCreateLabel ( 0.26, 0.850, 0.35, 0.04, "Транспорт: N/A", true, aTab1.Tab )
		aTab1.VehicleHealth	= guiCreateLabel ( 0.26, 0.895, 0.25, 0.04, "Здоровье транспорта: 0%", true, aTab1.Tab )
		aTab1.VehicleFix		= guiCreateButton ( 0.71, 0.845, 0.13, 0.04, "Починка", true, aTab1.Tab, "repair" )
		aTab1.VehicleDestroy	= guiCreateButton ( 0.71, 0.89, 0.13, 0.04, "Забрать", true, aTab1.Tab, "destroyvehicle" )
		...
		aTab1.AnonAdmin		  = guiCreateCheckBox (0.745, 0.942, 0.20, 0.04, "Анонимное администрирование", isAnonAdmin(), true, aTab1.Tab )
		...
		aTab2.ManageACL		= guiCreateButton ( 0.75, 0.02, 0.23, 0.04, "Редактирование ACL", true, aTab2.Tab )
		...
		aTab2.ResourceRefresh	= guiCreateButton ( 0.20, 0.915, 0.18, 0.04, "Обновить список", true, aTab2.Tab, "listresources" )
		...
		aTab2.ExecuteAdvanced	= guiCreateLabel ( 0.45, 0.71, 0.50, 0.04, "Только для отдельных игроков.", true, aTab2.Tab )
		...
		aTab3.GameType		= guiCreateLabel ( 0.05, 0.15, 0.40, 0.05, "Мод: нет", true, aTab3.Tab )
		aTab3.MapName		= guiCreateLabel ( 0.05, 0.20, 0.40, 0.05, "Карта: нет", true, aTab3.Tab )
		...
		aTab3.SetGameType		= guiCreateButton ( 0.78, 0.15, 0.2, 0.04, "Запустить мод", true, aTab3.Tab, "setgame" )
		aTab3.SetMapName		= guiCreateButton ( 0.78, 0.20, 0.2, 0.04, "Запустить карту", true, aTab3.Tab, "setmap" )
		...
		aTab3.WeatherCurrent	= guiCreateLabel ( 0.05, 0.35, 0.45, 0.05, "Погода: "..getWeather().." ("..getWeatherNameFromID ( getWeather() )..")", true, aTab3.Tab )
		...
		aTab3.WeatherSet		= guiCreateButton ( 0.50, 0.40, 0.12, 0.04, "Задать", true, aTab3.Tab, "setweather" )
		...
		aTab3.TimeSet		= guiCreateButton ( 0.50, 0.45, 0.12, 0.04, "Задать", true, aTab3.Tab, "settime" )
		...
		aTab3.GravitySet		= guiCreateButton ( 0.50, 0.50, 0.12, 0.04, "Задать", true, aTab3.Tab, "setgravity" )
		...
		aTab3.SpeedSet		= guiCreateButton ( 0.50, 0.55, 0.12, 0.04, "Задать", true, aTab3.Tab, "setgamespeed" )
		...
		aTab3.WavesSet		= guiCreateButton ( 0.50, 0.60, 0.12, 0.04, "Задать", true, aTab3.Tab, "setwaveheight" )
					 	 guiCreateLabel ( 0.63, 0.60, 0.09, 0.04, "( 0-100 )", true, aTab3.Tab )

		aTab4 = {}
		aTab4.Tab			= guiCreateTab ( "Баны", aTabPanel, "bans" )
		aTab4.BansList		= guiCreateGridList ( 0.03, 0.05, 0.80, 0.87, true, aTab4.Tab )
						  guiGridListAddColumn( aTab4.BansList, "Имя", 0.22 )
		...
		aTab4.Details		= guiCreateButton ( 0.85, 0.10, 0.13, 0.04, "Описание", true, aTab4.Tab )
		aTab4.Unban			= guiCreateButton ( 0.85, 0.20, 0.13, 0.04, "Разбанить", true, aTab4.Tab, "unban" )
		aTab4.UnbanIP		= guiCreateButton ( 0.85, 0.25, 0.13, 0.04, "Разбанить IP", true, aTab4.Tab, "unbanip" )
		aTab4.UnbanSerial		= guiCreateButton ( 0.85, 0.30, 0.13, 0.10, "Разбанить серийный номер", true, aTab4.Tab, "unbanserial" )
		...
		aTab4.BansTotal		= guiCreateLabel ( 0.20, 0.94, 0.31, 0.04, "Покзано  0 / 0  банов", true, aTab4.Tab )
		...
		aTab5.AdminPlayers	= guiCreateGridList ( 0.79, 0.05, 0.18, 0.80, true, aTab5.Tab )
						  guiGridListAddColumn ( aTab5.AdminPlayers, "Админины", 0.90 )
		...
		aTab5.AdminSay		= guiCreateButton ( 0.85, 0.92, 0.10, 0.06, "Сказать", true, aTab5.Tab )
		aTab5.AdminChatHelp	= guiCreateButton ( 0.96, 0.92, 0.03, 0.06, "?", true, aTab5.Tab )

		aTab6 = {}
		aTab6.Tab			= guiCreateTab ( "Настройки", aTabPanel )
						  guiCreateHeader ( 0.03, 0.05, 0.10, 0.05, "Основные:", true, aTab6.Tab )
		aTab6.OutputPlayer	= guiCreateCheckBox ( 0.05, 0.10, 0.47, 0.04, "Вывод информации об игроке в консоль", false, true, aTab6.Tab )
						  guiCreateLabel ( 0.08, 0.15, 0.50, 0.04, "полезно для копирования информации об игроке", true, aTab6.Tab )
		aTab6.AdminChatOutput 	= guiCreateCheckBox ( 0.05, 0.20, 0.47, 0.04, "Выводить сообщения админа в чат", false, true, aTab6.Tab )
						  guiCreateHeader (  0.03, 0.30, 0.47, 0.04, "Значения:", true, aTab6.Tab )
						  guiCreateHeader ( 0.63, 0.05, 0.10, 0.05, "Аккаунт:", true, aTab6.Tab )
		aTab6.AutoLogin		= guiCreateCheckBox ( 0.65, 0.10, 0.47, 0.04, "Автологин по серийн. номеру", false, true, aTab6.Tab )
						  ...
						  guiCreateLabel ( 0.65, 0.30, 0.15, 0.05, "Еще раз:", true, aTab6.Tab )
		...
		aTab6.PasswordChange	= guiCreateButton ( 0.85, 0.35, 0.10, 0.04, "Принять", true, aTab6.Tab )
						  guiCreateHeader ( 0.03, 0.65, 0.20, 0.055, "Производительность:", true, aTab6.Tab )
						  guiCreateStaticImage ( 0.03, 0.69, 0.94, 0.0025, "client\\images\\dot.png", true, aTab6.Tab )
						  guiCreateLabel ( 0.03, 0.71, 0.22, 0.055, "Приоритет:", true, aTab6.Tab )
...
function aAdminRefresh ()
	if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) ~= -1 ) then
		...
		if ( player and aPlayers[player] ) then
			...
			guiSetText ( aTab1.Mute, iif ( aPlayers[player]["mute"], "Приглушить", "Разрешить чат" ) )
			guiSetText ( aTab1.Freeze, iif ( aPlayers[player]["freeze"], "Заморозить", "Разморозить" ) )
			...
			if ( isPlayerDead ( player ) ) then guiSetText ( aTab1.Health, "Здоровье: умер" )
			...
			if ( getElementInterior ( player ) ) then guiSetText ( aTab1.Interior, "Здание: "..getElementInterior ( player ) ) end
			guiSetText ( aTab1.JetPack, iif ( doesPedHaveJetPack ( player ), "Убрать джетпак", "Дать джетпак" ) )
			...
			if ( vehicle ) then
				guiSetText ( aTab1.Vehicle, "Транспорт: "..getVehicleName ( vehicle ).." (ID: "..getElementModel ( vehicle )..")" )
				guiSetText ( aTab1.VehicleHealth, "Здоровье транспорта: "..math.ceil ( getElementHealth ( vehicle ) ).."%" )
			else
				guiSetText ( aTab1.Vehicle, "Транспорт: Foot" )
				guiSetText ( aTab1.VehicleHealth, "Здоровье транспорта: 0%" )
			end
			if ( aPlayers[player]["admin"] ) then
				guiSetText(aTab1.Admin, "Убрать права админа")
			else
				guiSetText(aTab1.Admin, "Дать права админа")
			end
			return player
		end
	end
	...
	if ( button == "left" ) then
		...
		if ( getElementParent ( source ) == aTab1.Tab ) then
			...
			elseif ( getElementType ( source ) == "gui-button" )  then
				...
				if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) == -1 ) then
					...
					if ( source == aTab1.Kick ) then aInputBox ( "Кик игрока "..name, "Причина кика", "", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"kick\", $value )" )
					...
					elseif ( source == aTab1.Mute ) then if not aPlayers[player]["mute"] then aMuteInputBox ( player ) else aMessageBox ( "Вопрос", "Разрешить чат "..name.."?", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"mute\" )" ) end
					...
					elseif ( source == aTab1.Nick ) then aInputBox ( "Задать ник", "Ввод нового ника для игрока", name, "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"nick\", $value )" )
					...
					elseif ( source == aTab1.SetDimension ) then aInputBox ( "ID измерения", "Введите ID измерения от 0 до 65535", "0", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"setdimension\", $value )" )
					...
					elseif ( source == aTab1.Admin ) then
						if ( aPlayers[player]["admin"] ) then aMessageBox ( "Внимание", "Убрать права админа у "..name.."?", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"setgroup\", false )" )
						else aMessageBox ( "Внимание", "Дать права админа "..name.."?", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"setgroup\", true )" ) end
					end
				end
			...
			elseif ( source == aTab1.PlayerList ) then
				if ( guiGridListGetSelectedItem( aTab1.PlayerList ) ~= -1 ) then
					...
					if ( player ) then
						...
						if ( ( guiCheckBoxGetSelected ( aTab6.OutputPlayer ) ) and ( player ) ) then outputConsole ( "Ник: "..aPlayers[player]["name"]..", IP: "..aPlayers[player]["IP"]..", Серийный номер: "..aPlayers[player]["serial"]..", Ник в сообществе: "..aPlayers[player]["username"]..", Аккаунт: "..aPlayers[player]["accountname"] ) end
					...
					guiSetText ( aTab1.Mute, "Запретить чат" )
		...
		elseif ( getElementParent ( source ) == aTab2.Tab ) then
			...
			elseif ( source == aTab2.ResourceList ) then
				guiSetVisible ( aTab2.ResourceFailture, false )
				if ( guiGridListGetSelectedItem ( aTab2.ResourceList ) ~= -1 ) then
					if ( guiGridListGetItemText ( aTab2.ResourceList, guiGridListGetSelectedItem( aTab2.ResourceList ), 3 ) == "Ошибка загрузки" ) then
		...
		elseif ( getElementParent ( source ) == aTab4.Tab ) then
			...
			elseif ( source == aTab4.Unban ) then
				if ( guiGridListGetSelectedItem ( aTab4.BansList ) == -1 ) then
					...
					else aMessageBox ( "Вопрос", "Разбанить IP "..selip.."?", "triggerServerEvent ( \"aBans\", getLocalPlayer(), \"unbanip\", \""..selip.."\" )" ) end
				end
			...
			elseif ( source == aTab4.UnbanSerial ) then
				aInputBox ( "Разбанить серийный номер", "Ввод серийного номера", "", "triggerServerEvent ( \"aBans\", getLocalPlayer(), \"unbanserial\", $value )" )
			...
			elseif ( source == aTab4.BanSerial ) then
				aInputBox ( "Бан серийного номера", "Ввод серийного номера", "", "triggerServerEvent ( \"aBans\", getLocalPlayer(), \"banserial\", $value )" )
		...
		elseif ( getElementParent ( source ) == aTab6.Tab ) then
			...
			elseif ( source == aTab6.PasswordChange ) then
				...
				elseif ( passwordNew ~= passwordConf ) then aMessageBox ( "Ошибка", "Пароли не совпадают" )
				else triggerServerEvent ( "aAdmin", getLocalPlayer(), "password", guiGetText ( aTab6.PasswordOld ), passwordNew, passwordConf ) end
			end
		end
	elseif ( button == "right" ) then
		if ( source == aTab1.GiveWeapon ) then aInputBox ( "Weapon Ammo", "Значения патронов от 1 до 9999", "100", "aSetCurrentAmmo ( $value )" )
		end
	end
end

...
function aManageSettings ( resName )
	...
	if ( aSettingsForm == nil ) then
		...
		aSettingsTab	= guiCreateTab ( "Игроки", aSettingsTabPanel, "players" )
		aSettingsList	= guiCreateGridList ( 0.03, 0.03, 0.94, 0.72, true, aSettingsTab )
						guiGridListAddColumn( aSettingsList, "Ник", 0.50 )
						guiGridListAddColumn( aSettingsList, "Текущие", 0.25 )
						guiGridListAddColumn( aSettingsList, "По умолчанию", 0.25 )
		aSettingsExit		= guiCreateButton ( 0.80, 0.93, 0.17, 0.04, "Закрыть", true, aSettingsTab )
	...
	guiSetText( aSettingsTab, resName .. " Настройки" )
